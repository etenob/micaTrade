...
## 👽 1. ALIEN 75 (Estrategia Institucional)

### 🖥️ ANALIZADOR
**¿Qué muestra y qué hace?**
Muestra una interfaz estricta con 6 indicadores en pantalla. Se encienden luces verdes si la Confianza de Señal es al menos del 75%, las Ballenas marcan compras (BULL), el precio está seguro por encima de la media de 55 periodos, la macroeconomía diaria es alcista, y hay fuerza de mercado (ADX > 25).
