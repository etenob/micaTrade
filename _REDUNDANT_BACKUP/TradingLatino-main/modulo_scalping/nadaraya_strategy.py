...
class NadarayaStrategy:
    def __init__(self, h=8.0, r=4.0, lag=2, atr_length=30, atr_mult=2, rsi_length=12):
        self.h = h
        self.r = r
        self.lag = lag
    ...
    def generate_signal(self, df: pd.DataFrame):
        ...
        try:
            ...
            # 2️⃣ ATR stops (✅ convertir a numpy)
            atr = ta.ATR(
