...
- Marcados con box.new() en el gráfico (TradingView).
...
1. El precio toca un OB → zona de interés.
2. El ADX está cerca o por encima del nivel 23 → fuerza confirmada.
3. El Squeeze cambia color o forma "gancho" → muestra pérdida o ganancia de momentum.
4. Se activa condición de Nadaraya (crossover/crossunder).
